...
def predict_datapoint():
    if request.method == 'POST':
        ...
        bill_amt_avg = round(np.mean(
            [data.BILL_AMT6, data.BILL_AMT5, data.BILL_AMT4, data.BILL_AMT3, data.BILL_AMT2, data.BILL_AMT1]), 2)
        ...
        # Print input features before prediction
        print("Input Features for Prediction:", features_arr)
